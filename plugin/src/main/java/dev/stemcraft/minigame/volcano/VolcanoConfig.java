...
final class VolcanoConfig {
    private final STEMCraftAPI api;
    private final VolcanoMiniGame owner;
    private final ConfigFile config;

    VolcanoConfig(STEMCraftAPI api, VolcanoMiniGame owner, ConfigFile config) {
        this.api = api;
        this.owner = owner;
        this.config = config;
    }
        ...
        for (String id : arenas.getKeys(false)) {
            ...
            try {
                ...
                if (validation.hasErrors())
                    api.messages().warn(VolcanoMiniGame.NAMESPACE + ": " + id + ": " + String.join("; ", validation.getErrors()));
                ...
                api.messages().warn("Cannot load " + VolcanoMiniGame.NAMESPACE + " arena " + id + ": " + ex.getMessage());
            }
        }
    }
