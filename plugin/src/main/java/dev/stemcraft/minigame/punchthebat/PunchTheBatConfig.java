...
final class PunchTheBatConfig {
    private final STEMCraftAPI api;
    private final PunchTheBatMiniGame owner;
    private final ConfigFile config;

    PunchTheBatConfig(STEMCraftAPI api, PunchTheBatMiniGame owner, ConfigFile config) {
        this.api = api;
        this.owner = owner;
        this.config = config;
    }
        ...
        for (String id : arenas.getKeys(false)) {
            ...
            try {
                ...
                if (validation.hasErrors())
                    api.messages().warn(PunchTheBatMiniGame.NAMESPACE + ": " + id + ": " + String.join("; ", validation.getErrors()));
                ...
                api.messages().warn("Cannot load " + PunchTheBatMiniGame.NAMESPACE + " arena " + id + ": " + ex.getMessage());
            }
        }
    }
