...
final class HorseRaceConfig {
    private final STEMCraftAPI api;
    private final HorseRaceMiniGame owner;
    private final ConfigFile config;

    HorseRaceConfig(STEMCraftAPI api, HorseRaceMiniGame owner, ConfigFile config) {
        this.api = api;
        this.owner = owner;
        this.config = config;
    }
        ...
        for (String id : arenas.getKeys(false)) {
            ...
            try {
                ...
                if (validation.hasErrors())
                    api.messages().warn(HorseRaceMiniGame.NAMESPACE + ": " + id + ": " + String.join("; ", validation.getErrors()));
                ...
                api.messages().warn("Cannot load " + HorseRaceMiniGame.NAMESPACE + " arena " + id + ": " + ex.getMessage());
            }
        }
    }
