 ...
 */
package dev.stemcraft.api.services.hologram;
...
public interface HologramService extends STEMCraftService {
     ...
     *
     * @param type  type/category (e.g. "UNIQUE", "LEADERBOARD", "NPC_NAME")
     * @param loc   base location for the hologram
     * @param lines lines to display (top to bottom)
     * @return hologram id
     */
